...
Example: Control servos connected to PWM driver onboard of Navio2 shield for
Raspberry Pi.
...
To use full range of your servo correct SERVO_MIN and SERVO_MAX according to
it's specification.

To run this example navigate to the directory containing it and run following
commands: make sudo ./Servo
*/
